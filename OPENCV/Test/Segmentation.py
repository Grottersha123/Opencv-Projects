...
def find_license(path,i):
    ...
    for point1, point2 in ter:
        ...
        char_image = dec.roi_area(im, point1, point2)
...
if __name__ == '__main__':
    ...
    # print(list_dir)
    for i in list_dir:
        chars = find_license("{0}\{1}".format(path, i),i)
        k.train_text(100,120,CHARS,'chars',r'D:\Github_project\OPENCV\Test\chars\chars')
        k.train_text(100,120,DIGITS,'digits',r'D:\Github_project\OPENCV\Test\chars\digits')
